 ...
 * @author pedro
 */
public class CriadorColecao extends javax.swing.JFrame {

    /**
     * Creates new form CriadorColecao
     */
    
    public static Registado registado;
    
    public CriadorColecao(Registado r) {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        dispose();
        registado.getCd().put(registado.getCd().size(),
                new Colecao(registado.getCd().size(), jTextField1.getText(), jTextField2.getText(), registado.getNome()));
        JOptionPane.showMessageDialog(rootPane, "Colecao " + jTextField1.getText() + " criada com sucesso!");
        new OrganizadorConteudoRegistado(registado).setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CriadorColecao.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
