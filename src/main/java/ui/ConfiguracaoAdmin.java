...
public class ConfiguracaoAdmin extends javax.swing.JFrame {
    ...
    /**
     * Creates new form ConfiguracaoAdmin
     */
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Bem vindo, configure a password que lhe dará direitos administrativos: ");
        ...
        jPasswordField2.setForeground(new java.awt.Color(230, 230, 230));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        if(jPasswordField1.getText().equals(jPasswordField2.getText())){
            ...
            facade.inicializaSistema(jPasswordField2.getText());
            JOptionPane.showMessageDialog(rootPane, "Administrador do sistema configurado com sucesso.");
            dispose();
            new MenuAdministrador(new Registado("admin", "", jPasswordField2.getText())).setVisible(true);
        }else
            JOptionPane.showMessageDialog(rootPane, "As duas passwords devem corresponder!");
